import PlayButton from "modules/studio/components/PlayButton";
import Bpm from "modules/studio/components/Bpm";
import TimeView from "modules/studio/components/TimeView";
